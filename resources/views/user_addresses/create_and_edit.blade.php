        ...
        <div class="col-md-10 offset-lg-1">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">{{ $address->id ? '编辑' : '新增' }}收货地址</h2>
                </div>
                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form action="{{ route('user_addresses.update', ['userAddress' => $address->id]) }}"
                                  class="form-horizontal" role="form"
                                  method="post">
                                {{ method_field('put') }}
                                @else
                                    <form action="{{ route('user_addresses.store') }}" class="form-horizontal"
                                          role="form"
                                          method="post">
                                        @endif
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label text-md-right col-md-2">详细地址</label>
                                            <div class="col-sm-9">
